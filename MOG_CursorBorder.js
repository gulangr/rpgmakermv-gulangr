...
SpriteSelectionMenu.prototype.loadBitmaps = function() {
	this._img1 = ImageManager.loadSystem(Moghunter.src_CursorBorderA);
	this._img1._fw = -1;
	this._img2 = ImageManager.loadSystem(Moghunter.src_CursorBorderB);
};
