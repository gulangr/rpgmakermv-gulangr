 ...
 * @desc 暴击图片的文件名 (放在 img/system/ 文件夹内)
 * @default Critical
 *
 * @param Counter Image
 * @desc 反击图片的文件名 (放在 img/system/ 文件夹内)
 * @default Counter
 *
 * @param Reflect Image
...
// --- 修改开始：读取新的图片参数 ---
    ...
    // 读取自定义图片文件名
    Moghunter.dmgp_critImg = String(Moghunter.parameters['Critical Image'] || "Critical");
    Moghunter.dmgp_cntImg = String(Moghunter.parameters['Counter Image'] || "Counter");
    Moghunter.dmgp_refImg = String(Moghunter.parameters['Reflect Image'] || "Reflect");
    // --- 修改结束 ---
//=============================================================================
// ** Game Action Result
//=============================================================================
...
// --- 新增辅助函数：加载自定义图片 ---
Sprite_Damage.prototype.createChildSpriteCustom = function(fileName) {
    var sprite = new Sprite();
    sprite.bitmap = ImageManager.loadSystem(fileName); // 从 img/system 加载
...
Sprite_Damage.prototype.createCritical = function() {
    ...
    sprite.dy = 0;
	//RYQ改
    sprite.yf2 = this.digitHeight() -50;
    if (this._zoomEffect && this._animeType === 1) {
        sprite.yf3 = 16;
        sprite.rotation = 0.1;
    };
    sprite.x = -2.5; // 强制居中 RYQ改
};
...
Sprite_Damage.prototype.createCounter = function() {
    // 使用自定义图片
    var sprite = this.createChildSpriteCustom(Moghunter.dmgp_cntImg);
    sprite.dy = 0;
    sprite.x = 0; // 强制居中
};
...
Sprite_Damage.prototype.createReflection = function() {
    // 使用自定义图片
    var sprite = this.createChildSpriteCustom(Moghunter.dmgp_refImg);
    sprite.dy = 0;
    sprite.x = 0; // 强制居中
};
