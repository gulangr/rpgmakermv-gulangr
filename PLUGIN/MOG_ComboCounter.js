...
/*:
 * @plugindesc (v1.5) Apresenta a quantidade de acertos no alvo.
 * @author Moghunter
 *
...
Scene_Map.prototype.terminate = function() {
	...
	if (this._spriteset && this._spriteset._hitCounterSprite) {
		this._spriteset.recordHitSpriteData()
	};
};
...
// * CreateLowerLayer
//==============================
var _mog_cCounter_SprtBattlecreateLowerLayer = Spriteset_Battle.prototype.createLowerLayer
Spriteset_Battle.prototype.createLowerLayer = function() {
	_mog_cCounter_SprtBattlecreateLowerLayer.call(this);
	this._hitCounterSprite = new HitCounterSprites();
	this.addChild(this._hitCounterSprite);
};
...
// * CreateLowerLayer
//==============================
var _mog_cCounter_SprtMapcreateLowerLayer = Spriteset_Map.prototype.createLowerLayer;
Spriteset_Map.prototype.createLowerLayer = function() {
	_mog_cCounter_SprtMapcreateLowerLayer.call(this);
...
//==============================
// * record Hit Sprite Data
//==============================
Spriteset_Base.prototype.recordHitSpriteData = function() {
    if (!this._hitCounterSprite) {return};
